...
session_start();
//mengecek user_nim pada session
...
<body id="body-pd">
        ...
        <nav class="nav">
            <div>
                <a href="#" class="nav_logo">
                    <img src="../img/logo_umb_white.webp" alt="" width="20">
                ...
                <div class="nav_list">
                    ...
                    <a href="dashboard.html" id="mahasiswa" class="nav_link"> <i class='bx bx-user nav_icon'></i>
    ...
    <div id="content" class="height-100">
